...
const StrategyStats = ({
  ...
  const getPromptDisplayString = (prompt) => {
    try {
      ...
      return (
        ...
        >
          <Typography variant="h5" gutterBottom>
            {displayNameOverrides[selectedStrategy] ||
              selectedStrategy}
          </Typography>
          <Typography variant="body2" color="text.secondary" gutterBottom>
            {subCategoryDescriptions[selectedStrategy] ||
              ''}
          </Typography>
                  ...
                  {getPluginStats(selectedStrategy).map((stat) => (
                    <TableRow key={stat.plugin}>
                      <TableCell component="th" scope="row">
                        {displayNameOverrides[stat.plugin] ||
                          stat.plugin}
                      </TableCell>
              ...
              return (
                ...
                >
                  <StyledStrategyName variant="body1">
                    {displayNameOverrides[strategy] ||
                      strategy}
                  </StyledStrategyName>
                  <StyledStrategyDescription variant="body2" color="text.secondary">
                    {subCategoryDescriptions[strategy] ||
                      ''}
