...
export const COLLECTIONS = ['default', 'foundation', 'harmful', 'pii'];
...
export const PII_PLUGINS = ['pii:api-db', 'pii:direct', 'pii:session', 'pii:social'] ;
...
export const CONFIG_REQUIRED_PLUGINS = ['intent', 'policy'] ;

// Plugins that don't use strategies (standalone plugins)
export const STRATEGY_EXEMPT_PLUGINS = ['pliny', 'system-prompt-override'] ;

export const DEFAULT_PLUGINS = new Set([
  ...[...BASE_PLUGINS, ...(Object.keys(HARM_PLUGINS)), ...PII_PLUGINS].sort(),
]);
...
export const OWASP_LLM_TOP_10_MAPPING = {
  'owasp:llm:01': {
    // Prompt Injection
...
export const OWASP_API_TOP_10_MAPPING = {
  'owasp:api:01': {
    plugins: ['bola', 'rbac'],
    strategies: [],
  },
...
export const ALIASED_PLUGIN_MAPPINGS = {
...
export const DEFAULT_STRATEGIES = ['basic', 'jailbreak', 'jailbreak:composite'] ;

export const MULTI_TURN_STRATEGIES = ['crescendo', 'goat'] ;
...
export const severityDisplayNames = {
 ...
 */
export const riskCategorySeverityMap = {
...
export const pluginDescriptions = {
  'ascii-smuggling':
...
export const strategyDisplayNames = {
...
export const PLUGIN_PRESET_DESCRIPTIONS = {
